...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Zakat</h4>
                    <p class="card-title-desc">
                    </p>
                    <form class="custom-validation" action="{{ route('zakat.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input name="keterangan" id="keterangan" data-parsley-type="number" type="text" class="form-control" required placeholder="Enter only numbers"/>
                                @error('keterangan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input name="tgl" id="tgl" type="text" class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true">
