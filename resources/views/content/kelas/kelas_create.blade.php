        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="{{ route('kelas.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Nama Kelas</label>
                            <input name="nama_kelas" id="nama_kelas" type="text" class="form-control" required placeholder="Type something"/>
                            @error('name')
