    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('profile.show') }}"><i class="ri-user-line align-middle mr-1"></i> {{ __('Profile') }}</a>
                    ...
                    <form method="POST" action="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">
                        ...
                        <a class="dropdown-item text-danger" href="{{ route('logout') }}">
                            <i class="ri-shut-down-line align-middle mr-1 text-danger"></i> {{ __('Log Out') }}
                        </a>
                    </form>
                </div>
            </div>
